  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        {[
          { label: 'Total Pedidos', value: stats.total, icon: ClipboardList, color: 'bg-[#F9FAFB] text-gray-500', iconColor: 'text-gray-500' },
          ...
          >
            <Card className={`bg-white border border-gray-200 shadow-none ${stat.label === 'Ofertas Pendientes' && stats.offers > 0 ? 'ring-2 ring-[#FFC145]/40' : ''}`}>
          ...
          <Card className="border-2 border-[#FFC145]/40 bg-white">
            ...
            <CardContent className="p-4 pt-0 space-y-3">
              {offerOrders.map((order: OrderItem) => (
                <div key={order.id} className="bg-[#F9FAFB] rounded-xl p-4 border border-[#FFC145]/20">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-gray-900">{order.driver?.name || 'Transportista'}</span>
                    {order.acceptedPrice && (
          ...
          <CardContent className="p-4 pt-0">
            {recentOrders.length === 0 ? (
              <div className="text-center py-10">
                ...
                <p className="text-xs text-gray-500 mt-1">Crea tu primer pedido de transporte</p>
                <Button
              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {recentOrders.map((order: OrderItem) => (
                  <button
                    ...
                    className="w-full text-left p-3 rounded-xl border border-gray-200 hover:border-[#1DB954]/30 hover:bg-[#1DB954]/5 transition-all"
                  >
                    <div className="flex items-center justify-between mb-2">
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg font-semibold text-gray-900">Mapa de Actividad</h2>
          <span className="text-xs text-gray-500">Centrado en Quito, Ecuador</span>
        </div>
        <MapView
          height="300px"
